...
static int rn5t618_gpio_get(struct gpio_chip *gc, unsigned offset)
{
...
static void rn5t618_gpio_set(struct gpio_chip *gc, unsigned offset, int value)
{
	struct rn5t618_gpio *priv = gpiochip_get_data(gc);
...
static int rn5t618_gpio_direction_input(struct gpio_chip *gc, unsigned offset)
{
	struct rn5t618_gpio *priv = gpiochip_get_data(gc);
