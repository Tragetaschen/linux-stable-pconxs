...
static ssize_t afe_on_show(struct device *dev, struct device_attribute *attr,
			   char *buf)
{
	u32 value;
...
static ssize_t afe_on_store(struct device *dev, struct device_attribute *attr,
...
static ssize_t hv_show(struct device *dev, struct device_attribute *attr,
		       char *buf)
{
	u32 value;
...
static ssize_t hv_store(struct device *dev, struct device_attribute *attr,
			const char *buf, size_t count)
{
	u32 value;
...
DEVICE_ATTR_RW(hv);
DEVICE_ATTR(dac1, 0644, dac_show, dac_store);
DEVICE_ATTR(dac2, 0644, dac_show, dac_store);
DEVICE_ATTR(dac3, 0644, dac_show, dac_store);
DEVICE_ATTR(dac4, 0644, dac_show, dac_store);
DEVICE_ATTR(dac5, 0644, dac_show, dac_store);
DEVICE_ATTR(dac6, 0644, dac_show, dac_store);
DEVICE_ATTR(dac7, 0644, dac_show, dac_store);
